/*!
 * easyEWS JavaScript Library v1.0.11
...
***********************************************************************************************/
                ...
                if(message != null && message.length > 0 && 
                   message[0].innerHTML == "No results were found.") {
                    ...
                    $.each(nodes, function (index, value) {
                        ...
                        returnArray.push(new ResolveNamesType(name, email, route, box));
                    });
    ...
    /**
     * PUBLIC: Class for wrapping the recipients returned from ResolveNames
     */
    class ResolveNamesType {
        /**
         * The CTOR for this type
         * @param {string} name
         * @param {string} emailAddress
         * @param {string} routingType
         * @param {string} mailboxType
         */
        constructor (name, emailAddress, routingType, mailboxType) {
            this.Name = name;
